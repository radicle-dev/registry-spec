...
\spec{
    ...
    \end{itemize}}
Projects are proposed with the \textsf{propose-project} transaction and subsequently registered
with the \textsf{accept-project} transaction.  The set of all registered projects is $\projects$.
The set of all proposals is $\pending$.
...
\subsection{The project contract}
