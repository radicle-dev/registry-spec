...
\[
    P = \tuple{\field{P}{name}, \field{P}{org}, \field{P}{k}, \field{P}{meta}}
\]

\spec{
    \definition
    \begin{itemize}
        \item $\field{P}{name}$ is the unique project name within the context of an $\field{P}{org}$,
...
\[
    \tx{register-project}{\field{P}{org}, \field{P}{name}, \field{P}{k}, \field{P}{meta}}
\]
The tuple $\tuple{\field{P}{org}, \field{P}{name}}$ is also known as $\field{P}{id}$.

\spec{
\inputs
\begin{itemize}
    \item $\field{P}{name}$ is the project name being requested,
...
\begin{itemize}
    ...
    \item $\tuple{\field{P}{org}, \field{P}{name}}$ is globally unique,
...
\inputs
\begin{itemize}
    \item $\field{P}{name}$ is the project name being unregistered,
...
\[
    U = \tuple{\field{U}{id}, \field{U}{account}, \field{U}{keys}, \field{U}{meta}}
\]
\spec{
    \definition
    \begin{itemize}
...
\outputs
\begin{itemize}
    \item $U \in \users$, where $U = \tuple{\field{U}{id}, \field{\origin}{id}, \varnothing, \field{U}{meta}}$
